-- KiWA Labs Chat System - Supabase Schema with Realtime
...
BEGIN;
  ...
  DROP VIEW IF EXISTS admin_chat_overview CASCADE;
...
COMMENT ON TABLE chat_sessions IS 'Stores chat conversations between users and AI/admin. Realtime enabled.';
COMMENT ON TABLE admin_messages IS 'Stores real-time messages from admin to users. Realtime enabled.';
